    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          {/* Image */}
          <img src="/media/image4.jpeg" alt="Blog Image" className="w-full h-300px object-cover rounded-lg shadow-md"/>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              In today’s fast-moving digital world, organizing and attending
              events should not feel complicated. Whether it’s a concert,
              campus event, conference, or cultural celebration, people want one
              thing: quick and reliable ticket access. That’s exactly what the
