    ...
    <div className="w-full overflow-x-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
          ...
          <div className="flex-1">
            <p className="text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 lg:leading-8 text-gray-700">
              Welcome to Sherehe Sasa support page. Were thrilled to have you
              here. This is your go-to place for assistance, tips, and resources
              to help you on your journey. Whether you have questions or need
      ...
      <div className="bg-green-50 rounded-lg shadow-md p-4 sm:p-6 lg:p-10 xl:p-20 m-4 sm:m-6 lg:m-10 text-center">
        <p className="text-sm sm:text-base lg:text-lg text-gray-700">
          Didnt find a solution? Talk to our world-class customer support
          agents. They are always available and ready to help.
        </p>
      </div>
